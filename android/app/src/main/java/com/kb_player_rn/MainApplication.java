...
import com.kb_player_rn.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.kb_player_rn.ReactNativeFlipper");
        aClass
          .getMethod(
            "initializeFlipper",
            Context.class,
